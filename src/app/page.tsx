...
import VisualisationSkills from "../components/visualisation-skills";
import TechincalSkills from "@/components/technical-skills";
  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        ...
        <Section>{/* Competent Tools section */}
          <TechincalSkills/>
        </Section>

        <Section>
          <h2 className="text-xl font-bold">About Me</h2>
          <AboutMe aboutMePoints={aboutMePoints}/>
          </Section>
            ...
            {RESUME_DATA.projects.map((project) => {
              return (
                <ProjectCard
                  ...
                  link={"link" in project && project.link ? project.link.href : undefined}
                />
              );
            })}
          </div>
...
<Section> {/* Data Skills section }
<DataSkills/>
</Section>

<Section> {/* Visualisation skills section }
  <VisualisationSkills/>
</Section>

<Section> {/* Business skills content here }
  <BusinessSkills/>
</Section>
